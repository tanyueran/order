...
public class RsaUtil {
    ...
    public static Map<String, String> genKeyPair() throws NoSuchAlgorithmException {
        ...
        // 将公钥和私钥保存到Map
        keyMap.put("private", publicKeyString);  //0表示公钥
        keyMap.put("public", privateKeyString);  //1表示私钥
        return keyMap;
    }
